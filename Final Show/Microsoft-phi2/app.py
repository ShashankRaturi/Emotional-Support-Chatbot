...
from llm_response import load_phi2_pipeline , generate_empathetic_response
import matplotlib.pyplot as plt


# load the pipeline
pipeline = load_phi2_pipeline()
...
if st.button("Generate Response"):
    if user_input.strip():
        with st.spinner("Please wait , while we analyzing..."):
            ...
            # generate response
            response = generate_empathetic_response(user_input , emotion , pipeline , max_new_tokens = 150)
